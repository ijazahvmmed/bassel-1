...
const StorySummary: React.FC = () => {
    return (
        <section className="py-12 md:py-20 lg:py-24 bg-brand-dark px-6 md:px-12 relative overflow-hidden">
            <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/stardust.png')] opacity-10"></div>

            <div className="container mx-auto flex flex-col items-center text-center max-w-4xl relative z-10">
                <h3 className="text-brand-red font-header font-bold tracking-[0.2em] mb-4 text-[10px] md:text-base animate-[fadeIn_1s_ease-out] uppercase">
                    The Story
                </h3>
                <h2 className="text-h1-mobile md:text-5xl lg:text-h1-desktop font-header font-bold text-white mb-6 uppercase leading-tight">
                    At 16, Lucan Zesh Inherited a Gift Most Nobles Dream Of
                </h2>
                <h4 className="text-h2-mobile md:text-2xl font-serif italic text-gray-400 mb-8 md:mb-12">
                    He didn't know it would cost him everything.
                </h4>

                <div className="prose prose-invert prose-base md:prose-lg text-gray-300 font-sans leading-relaxed text-left md:text-center">
                    <p className="mb-4 md:mb-6 text-body-mobile md:text-lg">
                    ...
                    <p className="text-body-mobile md:text-lg">
