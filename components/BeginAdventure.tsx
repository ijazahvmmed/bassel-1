        ...
        <section className="py-12 md:py-20 lg:py-24 bg-brand-dark overflow-hidden relative">
            ...
            <div className="container mx-auto px-6 md:px-12 relative z-10">
                <div className="flex flex-col items-center mb-10 md:mb-16 text-center">
                    <h2 className="text-h1-mobile md:text-5xl lg:text-h1-desktop font-header font-bold text-white uppercase mb-4">Begin Your Adventure</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
                    ...
                    {/* Card 1: Audiobook */}
                    <div className="group bg-black border border-white/10 p-6 md:p-8 flex flex-col hover:border-brand-red transition-all duration-300 hover:-translate-y-2">
                    ...
                    <div className="group bg-black border border-white/10 p-6 md:p-8 flex flex-col hover:border-brand-red transition-all duration-300 hover:-translate-y-2 relative overflow-hidden">
