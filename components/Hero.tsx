    ...
    <section id="home" ref={container} className="relative min-h-[600px] md:h-screen w-full overflow-hidden bg-black flex items-center justify-center py-16 md:py-0">
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto flex flex-col items-center">
        ...
        <div ref={buttonsRef} className="flex flex-col md:flex-row gap-4 md:gap-6 w-full md:w-auto">
          <a href={BOOK1_URL} target="_blank" rel="noopener noreferrer" className="group relative px-8 py-4 bg-brand-red border border-brand-red overflow-hidden transition-all hover:scale-105 shadow-[0_0_20px_rgba(220,38,38,0.5)] opacity-0 inline-block">
          ...
          <a href={BOOK1_URL} target="_blank" rel="noopener noreferrer" className="group relative px-8 py-4 bg-transparent border border-white/30 overflow-hidden transition-all hover:border-white hover:bg-white/10 opacity-0 inline-block">
