        ...
        <section className="py-24 bg-black relative">
            <div className="container mx-auto px-6 md:px-12 md:pl-32">
                <ScrollReveal animation="fade-up">
                    <div className="mb-16">
                        <h2 className="text-4xl md:text-5xl font-header font-bold text-white uppercase text-center md:text-left">For Fans Of...</h2>
                ...
                <ScrollReveal animation="fade-up" stagger={0.2}>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        {/* Cradle Readers */}
                        <div className="bg-brand-dark border border-white/10 p-8 hover:-translate-y-2 transition-transform duration-300 group opacity-0">
                            <h3 className="text-2xl font-header font-bold text-white uppercase mb-6 text-center group-hover:text-brand-red transition-colors">Cradle Readers</h3>

                            <div className="mb-6">
                                <h4 className="text-sm font-bold text-gray-500 uppercase tracking-widest mb-4 border-b border-white/10 pb-2">If you loved...</h4>
                            ...
                            <div>
                                <h4 className="text-sm font-bold text-brand-red uppercase tracking-widest mb-4 border-b border-brand-red/20 pb-2">You'll love Elder Lands because...</h4>
                                <ul className="text-white font-sans text-sm space-y-2">
                        ...
                        <div className="bg-brand-dark border border-white/10 p-8 hover:-translate-y-2 transition-transform duration-300 group opacity-0">
                            <h3 className="text-2xl font-header font-bold text-white uppercase mb-6 text-center group-hover:text-brand-red transition-colors">The Wandering Inn</h3>
                        ...
                        {/* HWFWM Readers */}
                        <div className="bg-brand-dark border border-white/10 p-8 hover:-translate-y-2 transition-transform duration-300 group opacity-0">
                            <h3 className="text-2xl font-header font-bold text-white uppercase mb-6 text-center group-hover:text-brand-red transition-colors">He Who Fights Monsters</h3>
