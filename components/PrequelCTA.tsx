            ...
            <div className="container mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center justify-between relative z-10 gap-8 md:gap-12">
                ...
                <div className="w-full md:w-2/3">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 md:gap-6 items-start">
                        <a href={BOOK1_URL} target="_blank" rel="noopener noreferrer" className="bg-white text-brand-red font-header font-bold uppercase tracking-widest py-3 md:py-4 px-8 md:px-12 text-xs md:text-sm shadow-xl hover:bg-black hover:text-white transition-colors duration-300 transform hover:-translate-y-1 block text-center">
                            Download Free on Amazon
                        </a>
                        <p className="text-white/70 text-[10px] md:text-xs max-w-xs mt-2 font-sans md:mt-0">
                            *You'll also get exclusive updates on Book 5 & author notes via Amazon Follow. Unsubscribe anytime.
                        </p>
                    </div>
                </div>
